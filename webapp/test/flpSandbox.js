		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dock Audit Checking",
									"targetURL": "#comewmauditparkerzewmauditcheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comewmauditparkerzewmauditcheck-display": {
								"semanticObject": "comewmauditparkerzewmauditcheck",
								"action": "display",
								"description": "Dock Audit checking for Outbound Delivery",
								"title": "Dock Audit Checking",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ewm.audit.parker.zewmauditcheck",
									"url": sap.ui.require.toUrl("com/ewm/audit/parker/zewmauditcheck")
								}
							}
						}
					}
